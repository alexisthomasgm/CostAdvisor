...
class ActualVolume(Base):
    __tablename__ = "actual_volumes"
    __table_args__ = (
    ...
    volume: Mapped[float] = mapped_column(Numeric(14, 4), nullable=False)
    ...
    # Relationships
    cost_model = relationship("CostModel", back_populates="actual_volumes")
